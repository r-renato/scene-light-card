...
declare global {
  interface HTMLElementTagNameMap {
    "action-handler-scene-light": ActionHandler;
  }
...
customElements.define("action-handler-scene-light", ActionHandler);

const getActionHandler = (): ActionHandlerType => {
  const body = document.body;
  if (body.querySelector("action-handler-scene-light")) {
    return body.querySelector("action-handler-scene-light") as ActionHandlerType;
  }

  const actionhandler = document.createElement("action-handler-scene-light");
